        ...
        >
          <el-form :label-position="labelPosition" :rules="rules" label-width="80px" :model="bannerInfo">
            <el-form-item label="广告图片" prop="img">
              <el-col :span="16">
                <img :src="bannerInfo.img===undefined || bannerInfo.img.includes('data:image')?bannerInfo.img:$store.state.baseURL+bannerInfo.img" ref="previewImg" alt="" width="375px" height="150px">
          ...
          async manageBannerInfo(){
            if (this.bannerInfo.img) {
                if(this.$refs.uploadImg.files[0]){
                    ...
                    if (json.state===200){
                        if (json.data){
                            this.bannerInfo.img = '/upFile/'+json.data.img;
                        }
                    }else{
