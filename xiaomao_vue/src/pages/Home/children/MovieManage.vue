        ...
        >
          <el-form :label-position="labelPosition" :rules="rules" label-width="80px" :model="movieInfo">
            ...
            <el-form-item label="海报" prop="img">
              <el-col :span="16">
                <img :src="movieInfo.img===undefined||movieInfo.img.includes('data:image')?movieInfo.img:$store.state.baseURL+movieInfo.img" ref="previewImg" alt="" width="150px" height="200px">
            ...
            <el-form-item label="视频图片" prop="videoImg">
              <el-col :span="16">
                <img :src="$store.state.baseURL+movieInfo.videoImg" ref="previewImg1" alt="" width="200px" height="120px">
            ...
            <el-form-item label="宣传视频" prop="videoUrl">
              <el-col :span="16">
                <video :src="$store.state.baseURL+movieInfo.videoUrl" ref="previewVideo" controls :poster="movieInfo.videoImg" width="300px" height="150px"></video>
              ...
              <el-row :span="16">
                <ul class="upload-imgs">
                  <li v-if="isNew" v-for='(value,index) in newPhotos'>
                    <p class="img"><img :src="$store.state.baseURL+value" width="150px" height="90px"><a class="close" @click="delImg2(index)">×</a></p>
                  </li>
                  <li v-if="!isNew"  v-for='(value,index) in movieInfo.photosList'>
                    <p class="img"><img :src="$store.state.baseURL+value" width="150px" height="90px"><a class="close" @click="delImg1(index)">×</a></p>
                  </li>
                </ul>
                <div style="position: relative;height: 20px">
                  <el-button size="small" type="primary" style="position: absolute;left: 0;top: 0;cursor: pointer">点击上传</el-button>
          ...
          async addImg(e){
            ...
            if (json.state==200){
              ...
              if (this.dialogTitle === '编辑电影信息') {
                this.movieInfo.photosList.push("/upFile/"+json.data.img);
              } else{
                this.newPhotos.push("/upFile/"+json.data.img);
              }
            }
          ...
          async manageMovieInfo(){
            if (this.movieInfo.nm&&this.movieInfo.img&&this.movieInfo.dir&&this.movieInfo.star&&this.movieInfo.dur&&this.movieInfo.cat&&this.movieInfo.language&&this.movieInfo.rt&&this.movieInfo.dra) {
              ...
              if (json.state===200){
                ...
                if (json.data){
                  if(json.data.img)
                    this.movieInfo.img = '/upFile/'+json.data.img;
                  if(json.data.videoImg)
                    this.movieInfo.videoImg = '/upFile/'+json.data.videoImg;
                  if(json.data.video)
                    this.movieInfo.videoUrl = '/upFile/'+json.data.video;
                }
                //判断是编辑还是添加
                if (this.dialogTitle === '编辑电影信息') {
